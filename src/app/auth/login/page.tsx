...
const Login = () => {
  ...
  return (
    <div className='flex h-screen w-full py-2'>
      <div className='hidden md:flex flex-col gap-10 w-1/2 h-full bg-linear-to-t from-white/80 to-black rounded-lg p-10'>
        ...
        <div className="h-full w-full flex flex-col mt-20">
          <h2 className="text-5xl font-bold text-white font-theme leading-tight">
            From prompt
            <br />
            to <span className="text-white/50">pixel - perfect</span> UI.
          </h2>
      ...
      <div className="flex flex-col justify-center items-center gap-10 bg-black/85 w-full md:w-1/2 h-full p-20 z-20">
