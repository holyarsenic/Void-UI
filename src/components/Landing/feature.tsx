    ...
    <section className="relative flex min-h-screen w-full items-center overflow-hidden bg-background px-6 py-12 sm:px-10 md:py-16 md:px-20">
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl">
        ...
        <div className="max-w-2xl">
          <h2 className="text-2xl font-theme text-foreground md:text-5xl">
            Stop building
            <br />
            the same UI twice.
          </h2>
        ...
        <p className="mt-10 text-lg font-medium uppercase tracking-widest text-foreground">
            Why Void UI?
        </p>

        <div className="mt-3 grid overflow-hidden rounded-2xl border border-foreground/10 bg-foreground/5 sm:grid-cols-2 lg:grid-cols-4 backdrop-blur-2xl">
          {features.map((feature) => (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <span className="h-1.5 w-1.5 rounded-full bg-foreground/20 transition-all duration-300 group-hover:scale-150 group-hover:bg-foreground" />
              </div>
